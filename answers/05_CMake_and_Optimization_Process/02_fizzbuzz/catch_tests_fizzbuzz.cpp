//
// Created by johannes on 20.11.23.
//
#include "catch/include/catch.hpp"
#include "fizzbuzz/include/fizzbuzz.h"
#include <string>
...
TEST_CASE("number overflow", "[stability]"){
    REQUIRE(fizzbuzz(2147483647) == "2147483647");
    REQUIRE(fizzbuzz(2147483648) == "-2147483648");
}